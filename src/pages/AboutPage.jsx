        ...
        <div className='about-content'>
          ...
          <div className="timeline-flex">
            ...
            <div className="right-content">
              ...
              <div className="content">
                <h2>Objective</h2>
                <p>CUAD takes on extreme, real-world challenges. This year, we are developing multiple high-performance drones, including a missile-style autonomous glider designed to be released from our large carrier drone, deploy its wings, and operate as a surveillance platform. We are also creating a gesture-controlled drone that responds to user movements, and upgrading our unique drone, Buttery, to autonomously navigate an obstacle course and retrieve objects with a retractable grabber. Our objective is to complete the International Aerial Robotics Competition (a fully autonomous, gesture controlled, mine detecting drone swarm). Beyond these projects, we push the limits with ultra-fast drones and rare, innovative designs. At CUAD, the possibilities are endless: every new idea is considered, and as a team, we choose projects that are both exciting and highly challenging.</p>
              </div>
            </div>
          </div>
        </div>
