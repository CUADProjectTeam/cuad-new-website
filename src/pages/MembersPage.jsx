...
const MembersPage = () => {
  ...
  const members = [
    ...
    { image: './images/Members/CUAD_Nandiniy.jpg', name: 'Nandiniy Velayudhan-Dhamrait', team: 'Business Lead', major: 'Biological Sciences', year: '2028', hometown: 'Seattle, Washington', bio:'She is passionate about biotechnology and the healthcare industry.' },
    { image: './images/Members/CUAD_Sahasra.jpg', name: 'Sahasra Kalwala', team: 'Business Lead', major: 'Economics & Information Science', year: '2029', hometown: 'Aldie, Virginia', bio: 'She is interested in the intersection of business and technology.'},,
    ...
    { image: './images/Members/CUAD_Etienne.jpg', name: 'Etienne Sasenarine', team: 'Computer Science Lead', year: '2028', major: 'Computer Science', hometown: 'Long Island, New York', bio: 'He is interested in the intersection of Robotics and Artificial Intelligence to develop innovative autonomous systems.' },
    ...
    { image: './images/Members/CUAD_Gene.jpg', name: 'Geneustace Wickasono', team: 'Electrical', major: 'Electrical and Computer Engineering', year: '2027', hometown: 'Ithaca, New York' },
