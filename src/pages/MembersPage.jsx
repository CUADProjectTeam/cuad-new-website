...
const MembersPage = () => {
  ...
  const members = [
    ...
    { image: './images/Members/CUAD_Lulu.jpg', name: 'Lujine Abdelfattah', team: 'Full Team Lead', major: 'Computer Science', year:'2027', hometown: 'Garfield, New Jersey', bio: 'She enjoys reading, watching movies, swimming, and traveling with friends.' }, //no pic
    ...
    { image: './images/Members/CUAD_Alex.jpg', name: 'Alexander Barry', team: 'Mechanical Lead', major: 'Mechanical Engineering', year: '2027', hometown: 'Newark, Delaware', bio: 'He enjoys flying FPV drones.'},
    { image: './images/Members/CUAD_Etienne.jpg', name: 'Etienne Sasenarine', team: 'Computer Science Lead', year: '2028', major: 'Computer Science', hometown: 'Long Island, New York', bio: 'He enjoys playing tennis.' },
